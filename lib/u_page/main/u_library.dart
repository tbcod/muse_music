...
import 'package:music_muse/u_page/main/libray/u_loc_playlist.dart';
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color: Color(0xffB4F6FF)
                                              .withOpacity(0.09),
                                        ),
                                        child: controller
                                                .downloadCover.isNotEmpty
                                            ? Container(
                                                clipBehavior: Clip.hardEdge,
                                                decoration: BoxDecoration(
                                                    borderRadius:
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius:
                                            BorderRadius.circular(10.w),
                                        color:
                                            Color(0xffFFEAEC).withOpacity(0.15),
                                      ),
                                      width: 108.w,
                                      height: 130.w,
    ...
    return InkWell(
      onTap: () {
        if (isNetPlaylist) {
          //网络歌单
          EventUtils.instance
              .addEvent("det_playlist_show", data: {"from": "library"});
