...
import 'package:music_muse/page/main/home/add_list.dart';
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    children: [
                                    ...
                                    children: [
                                      ...
                                      Obx(() {
                                        ...
                                        return Container(
                                          ...
                                          child: cover == null
                                              ? Image.asset(
                                                  "assets/img/icon_p_empty_cover.png",
                                                  fit: BoxFit.cover,
                                                )
                                              : Image.memory(
                                                  cover,
                          ...
                          children: [
                            ...
                            Obx(() => InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    controller
                                        .playMusic(controller.nowIndex - 1);
                                  },
                                )),
                            SizedBox(
                              width: 35.w,
                            ...
                            children: [
                              Obx(() => Container(
                                    ...
                                    child: SliderTheme(
                                      ...
                                      child: Slider(
                                        value: max(0, min(controller.sliderValue.value, 1)),
                                        onChanged: (value) {
                                          //计算时间
                      ...
                      SizedBox(
                        height: Get.mediaQuery.padding.bottom + 50.w,
                      )
                    ],
                  ))
                ],
...
class PlayPageController extends GetxService {
  var tabIndex = 0.obs;
  ...
  realPlay(int index) {
    ...
    player
        .play(BytesSource(playList[index]["fileData"], mimeType: "audio/mp3"));
  ...
  showFloatingWidget() {
    ...
    //                                   ? "assets/img/icon_b_pause.png"
    //                                   : "assets/img/icon_b_play.png"),
    //                             ),
    //                             onTap: () async {
    //                               if (isPlaying.value) {
    //                                 await player.pause();
  ...
  void onInit() async {
    super.onInit();
    myHandler = await AudioService.init(builder: () => MyAudioHandler());
  }
}
